...
void PushVariant(HSQUIRRELVM vm, const ScriptVariant_t& value)
{
	...
	case FIELD_FLOAT:
		...
		break;
	case FIELD_FLOAT64:
		sq_pushfloat(vm, (float)value.m_float64);
		break;
	case FIELD_CSTRING:
...
void GetVariantScriptString(const ScriptVariant_t& value, char *szValue, int iSize)
{
	switch (value.m_type)
	{
		...
		case FIELD_FLOAT:
			...
			break;
		case FIELD_FLOAT64:
			V_snprintf( szValue, iSize, "%lf", value.m_float64 );
			break;
		case FIELD_CSTRING:
		...
		case FIELD_INTEGER:
			...
			break;
		case FIELD_UINT:
			V_snprintf( szValue, iSize, "%u", value.m_uint );
			break;
		case FIELD_UINT64:
			V_snprintf( szValue, iSize, "%llu", value.m_uint64 );
			break;
		case FIELD_BOOLEAN:
