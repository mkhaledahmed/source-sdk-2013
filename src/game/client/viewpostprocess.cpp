...
void DoImageSpaceMotionBlur( const CViewSetup &viewBlur )
{
	...
	int x = viewBlur.x;
	int y = viewBlur.y;
	int w = viewBlur.width;
	int h = viewBlur.height;
	...
	if ( true )
	{
		...
		//======================//
		Vector vCurrentPosition = { viewBlur.origin.x, viewBlur.origin.y, viewBlur.origin.z };
