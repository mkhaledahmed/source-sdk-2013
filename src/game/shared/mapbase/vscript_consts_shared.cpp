...
void RegisterSharedScriptConstants()
{
	...
	// TODO: Add to non-Mapbase VScript
#ifdef VSCRIPT_PRIORITIZE_TF2_SYNTAX
	ScriptRegisterConstantNamed( g_pScriptVM, 1, "VSCRIPT_PRIORITIZE_TF2_SYNTAX", "Whether this mod prioritizes TF2 VScript syntax over Mapbase VScript syntax." );
#else
	ScriptRegisterConstantNamed( g_pScriptVM, 0, "VSCRIPT_PRIORITIZE_TF2_SYNTAX", "Whether this mod prioritizes TF2 VScript syntax over Mapbase VScript syntax." );
#endif
	...
	ScriptRegisterConstant( g_pScriptVM, EFL_FORCE_ALLOW_MOVEPARENT, "Entity flag used in GetEFlags(), etc." );
